...
function initItinerary() {
  ...
  const itineraryData = [
    { date: '2026-05-09', day: 1, location: '桃園機場', activity: '啟程', driving_info: '無 (搭機)', accommodation: '機上', guide_tips: '準備好頸枕，強迫自己睡覺調整時差。', recommendations: '', notes: '搭乘 NZ78', backup: '' },
    { date: '2026-05-10', day: 2, location: '奧克蘭 → 基督城', activity: '抵達/轉機', driving_info: 'CHC 機場 ➔ 市區 (約 10km, 20分)', accommodation: '基督城市區飯店', guide_tips: '轉機時間充裕，出了國際線之後請推行李步行至國內線重新托運。', recommendations: 'Riverside Market (全天)：抵達後很適合先吃熱食並採買食材。', notes: '09:20 抵達 AKL → 14:25 捷星國內線 → CHC → Riverside Market', backup: '' },
    { date: '2026-05-11', day: 3, location: '基督城 → 蒂卡波湖', activity: '取車出發', driving_info: 'CHC ➔ Castle Hill (95km, 1.5h) ➔ Tekapo (200km, 2.5h) | 本日總車程：約 4 小時', accommodation: 'Lake Tekapo M&H Park', guide_tips: '第一天開露營車務必慢行，適應右駕與龐大車體。5月中夜間氣溫常低於 5 度，露營車務必學習開啟柴油暖氣。', recommendations: '', notes: '10:00 取車 → 超市採購 → Castle Hill → Tekapo', backup: '出發若太晚果斷放棄巨石陣，走 SH1 直奔營地' },
    { date: '2026-05-12', day: 4, location: '蒂卡波湖', activity: '觀光', driving_info: '鎮上短途移動 (單趟約 5-10 分鐘)', accommodation: 'Lake Tekapo M&H Park', guide_tips: '山區天氣多變，下午若出太陽請立刻去走步道，不要等明天！', recommendations: '', notes: '牧羊人教堂 → 午餐炸魚薯條 → Mt John 觀星團', backup: '觀星若因雲層太厚取消，改去 Tekapo Springs 泡溫泉' },
    ...
    { date: '2026-05-19', day: 11, location: '皇后鎮', activity: '觀光/活動', driving_info: '市區短途移動或搭乘接駁車', accommodation: 'Queenstown Top 10', guide_tips: '跳傘務必預約第一批！Onsen 溫泉非常熱門，出發前 2 個月就要預訂。', recommendations: '', notes: 'NZONE 跳傘 → 市區逛街 → Onsen 泡湯', backup: '跳傘若取消，改去 Deer Park Heights 餵動物' },
